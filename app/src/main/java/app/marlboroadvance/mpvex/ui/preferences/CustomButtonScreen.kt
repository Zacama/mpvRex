        ...
        val exportLauncher = rememberLauncherForActivityResult(
            ...
            uri?.let {
                runCatching {
                    ...
                    Toast.makeText(context, context.getString(R.string.custom_button_export_success), Toast.LENGTH_SHORT).show()
                }.onFailure { e ->
            ...
            topBar = {
                TopAppBar(
                    title = {
                        Column {
                            Text(
                                text = stringResource(R.string.custom_button_screen_title),
                                style = MaterialTheme.typography.headlineSmall,
                                fontWeight = FontWeight.ExtraBold,
                                color = MaterialTheme.colorScheme.primary,
                            )
                            Text(
                                text = stringResource(R.string.custom_button_screen_subtitle),
                ...
                item {
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(R.string.custom_button_import_export),
                            ...
                            Text(
                                text = stringResource(R.string.custom_button_import_export_summary),
                            ...
                            Row(
                                ...
                                Button(
                                    ...
                                    Spacer(Modifier.width(8.dp))
                                    Text(stringResource(R.string.generic_export))
                                }
                            }
                        }
                    }
                ...
                onConfirm = {
                    ...
                    Toast.makeText(
                        ...
                        context.resources.getQuantityString(
                            R.plurals.custom_button_imported,
...
fun ButtonSlotCard(
        ...
        Column(Modifier.fillMaxWidth()) {
            ...
            Row(
                ...
                Column(Modifier.weight(1f)) {
                    ...
                    Text(
                        text = draftTitle.ifBlank { if (isPopulated) button!!.title else stringResource(R.string.custom_button_empty_slot) },
                ...
                if (isPopulated) {
                    ...
                    Icon(
                        Icons.Default.DragHandle,
                        contentDescription = stringResource(R.string.custom_button_drag_disabled),
    ...
    if (activeLuaField != null) {
        ...
        val fieldLabel = when (fieldKey) {
            "content"   -> stringResource(R.string.custom_button_field_tap, slotLabel)
            "longPress" -> stringResource(R.string.custom_button_field_longpress, slotLabel)
            "startup"   -> stringResource(R.string.custom_button_field_startup, slotLabel)
            else        -> fieldKey
        }
...
fun ButtonExpandedContent(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label         = { Text(stringResource(R.string.custom_button_title_label)) },
            modifier      = Modifier.fillMaxWidth(),
            singleLine    = true,
            shape         = RoundedCornerShape(12.dp),
        )
        ...
        // Tap action — required
        LuaEditorEntryCard(
            label      = stringResource(R.string.custom_button_tap_action),
            code       = draftContent,
            isRequired = true,
        ...
        // Long press
        LuaEditorEntryCard(
            label   = stringResource(R.string.custom_button_long_press_action),
            code    = draftLongPress,
        ...
        // On startup
        LuaEditorEntryCard(
            label   = stringResource(R.string.custom_button_on_startup),
            code    = draftStartup,
        ...
        Row(
            ...
            Column(Modifier.weight(1f)) {
                Text(
                    text  = stringResource(R.string.custom_button_enabled),
                    style = MaterialTheme.typography.titleSmall,
                    fontWeight = FontWeight.Medium,
                    color = MaterialTheme.colorScheme.onSurface,
                )
                Text(
                    text  = if (draftEnabled) {
                        stringResource(R.string.custom_button_enabled_summary)
                    } else {
                        stringResource(R.string.custom_button_disabled_summary)
                    },
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
        ...
        Row(
            ...
            TextButton(
                ...
                Text(if (isPopulated) stringResource(R.string.generic_save) else stringResource(R.string.custom_button_add))
            }
        }
    }
}
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                if (hasCode) {
                    ...
                    Text(
                        text = stringResource(R.string.custom_button_tap_to_write_lua),
                        style = MaterialTheme.typography.bodySmall,
        ...
        topBar = {
            TopAppBar(
                title = {
                    Column {
                        Text(
                            text = stringResource(R.string.custom_button_select_import),
                            style = MaterialTheme.typography.titleLarge,
                            fontWeight = FontWeight.Bold,
                            color = MaterialTheme.colorScheme.primary,
                        )
                        Text(
                            text = stringResource(R.string.custom_button_select_import_summary),
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                        )
                    }
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            if (willOverwrite) {
                                ...
                                Row(
                                    ...
                                    Spacer(Modifier.width(4.dp))
                                    Text(
                                        text = stringResource(R.string.custom_button_overwrite_warning),
                                        style = MaterialTheme.typography.labelSmall,
                                        color = MaterialTheme.colorScheme.error,
                                    )
                                }
