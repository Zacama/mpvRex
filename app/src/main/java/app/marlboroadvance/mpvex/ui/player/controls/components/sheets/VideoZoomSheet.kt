  ...
  Column(
    ...
    Row(
      ...
      FilledTonalIconButton(
        ...
        Icon(Icons.Default.Remove, contentDescription = stringResource(R.string.zoom_decrease), modifier = Modifier.size(18.dp))
      }
      ...
      FilledTonalIconButton(
        ...
        Icon(Icons.Default.Add, contentDescription = stringResource(R.string.zoom_increase), modifier = Modifier.size(18.dp))
      }
    }
