...
fun PermissionDeniedState(
            ...
            Text(
              text = if (isPlayStoreBuild) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                  stringResource(R.string.permission_request_photos_videos)
                } else {
                  stringResource(R.string.permission_request_storage)
                }
              } else {
                stringResource(R.string.permission_request_all_files)
              },
  ...
  if (showExplanationDialog) {
    ...
    AlertDialog(
      ...
      title = {
        Text(
          text = stringResource(R.string.permission_why_header),
      ...
      text = {
        Column(
          ...
          if (isPlayStoreBuild) {
            ...
            Text(
              text = stringResource(R.string.permission_why_core),
              style = MaterialTheme.typography.bodyMedium,
            ...
            Text(
              text = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                stringResource(R.string.permission_why_android13)
              } else {
                stringResource(R.string.permission_why_legacy)
              },
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            ...
            Text(
              text = stringResource(R.string.permission_why_used_for),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
              fontWeight = FontWeight.Medium,
            )
            ...
            Text(
              text = stringResource(R.string.permission_why_used_for_items),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          } else {
            ...
            Text(
              text = stringResource(R.string.permission_why_history),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )

            Text(
              text = stringResource(R.string.permission_why_policy),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )

            Text(
              text = stringResource(R.string.permission_why_scope),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          }
          ...
          Text(
            text = stringResource(R.string.permission_why_open_source),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
          ...
          Text(
            text = stringResource(R.string.permission_why_privacy),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
            fontWeight = FontWeight.Medium,
          )
