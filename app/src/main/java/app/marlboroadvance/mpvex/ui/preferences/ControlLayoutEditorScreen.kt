...
data class ControlLayoutEditorScreen(
  ...
  override fun Content() {
    ...
    val title = stringResource(
      when (region) {
        ControlRegion.TOP_RIGHT -> R.string.layout_editor_region_top_right
        ControlRegion.BOTTOM_RIGHT -> R.string.layout_editor_region_bottom_right
        ControlRegion.BOTTOM_LEFT -> R.string.layout_editor_region_bottom_left
        ControlRegion.PORTRAIT_BOTTOM -> R.string.layout_editor_region_portrait_bottom
        ControlRegion.MORE_SHEET -> R.string.layout_editor_region_more_sheet
      }
    )

    if (showResetDialog) {
      ConfirmDialog(
        title = stringResource(R.string.layout_editor_reset_title),
        subtitle = stringResource(R.string.layout_editor_reset_subtitle),
        onConfirm = {
          isReset = true
      ...
      ProvidePreferenceLocals {
        ...
        LazyVerticalGrid(
          ...
          item(span = { GridItemSpan(maxLineSpan) }) {
            Text(
              text = stringResource(R.string.layout_editor_hint),
            ...
            item(span = { GridItemSpan(maxLineSpan) }) {
              androidx.compose.material3.Surface(
                ...
                Column(
                  ...
                  Text(
                    text = stringResource(R.string.layout_editor_drop_zone_empty),
                    style = MaterialTheme.typography.bodyMedium,
                    fontWeight = FontWeight.Medium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                  )
                  Text(
                    text = stringResource(R.string.layout_editor_tap_palette),
              ...
              FlowRow(
                ...
                if (orphanedButtons.isEmpty()) {
                  Box(modifier = Modifier.fillMaxWidth().padding(vertical = 16.dp), contentAlignment = Alignment.Center) {
                    Text(text = stringResource(R.string.layout_editor_all_in_use), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                  }
                }
              }
            }
...
private fun IconsLegend() {
  androidx.compose.material3.Card(
    ...
    Column(modifier = Modifier.fillMaxWidth().padding(20.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
      Text(text = stringResource(R.string.layout_editor_icons_legend), style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.onSurface)
