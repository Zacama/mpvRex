...
object PlaylistScreen : Screen {
    ...
    Scaffold(
        ...
        if (isSearching && filteredPlaylists.isEmpty() && searchQuery.isNotBlank()) {
          ...
          Box(
            ...
            EmptyState(
              ...
              title = stringResource(R.string.playlist_none_found),
          ...
          Box(
            ...
            Column(
              ...
              EmptyState(
                ...
                title = stringResource(R.string.playlist_none_yet),
      ...
      if (showDeleteDialog) {
        DeleteConfirmationDialog(
          ...
          titlePluralRes = R.plurals.delete_title_playlist,
  ...
  private fun PlaylistListContent(
    ...
    UnifiedExplorerContent(
      ...
      modifier = modifier,
      emptyTitle = stringResource(R.string.playlist_none_found),
      emptyMessage = stringResource(R.string.playlist_empty_state_message),
      isRefreshing = isRefreshing,
      onRefresh = onRefresh,
